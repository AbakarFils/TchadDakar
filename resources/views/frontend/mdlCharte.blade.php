<!------------------Debut Charte des Investissements---------------------!-->
<div class="modal fade" id="charte" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Charte des Investissements</h4>
            </div>
            <div class="modal-body">
                ...
                <div id="suite" class="collapse">
                    <h1 class="text-center text-danger">Des dispositions générales</h1>
...
<!------------------Fin Charte des Investissements------------------------!-->